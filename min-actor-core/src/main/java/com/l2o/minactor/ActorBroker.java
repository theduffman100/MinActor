...
public interface ActorBroker {
  ...
  /**
   * Sets the default broker to use for outgoing call that expect a response, and
   * returns a closeable to restore it to the previous value.
   * 
   * @param broker The broker to use
   * @return A Closeable allowing try/with to revert to the previous value
   */
