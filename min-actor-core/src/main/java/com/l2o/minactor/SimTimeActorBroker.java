...
/**
 * Simulated time implementation of the ActorBroker interface.
 * This will consume asynchronous events in an eager fashion, and advance the current
 * simulated time as it consumes time events.
 */
