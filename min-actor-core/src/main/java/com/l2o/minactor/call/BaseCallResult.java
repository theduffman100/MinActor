...
/**
 * An object that can be used to attach handlers to inter-actor calls with a return value.
 *
...
public class BaseCallResult<RESULT> implements CallResult<RESULT> {
    ...
    /**
     * Package-scope constructor. This object is created by the BaseActor and it shares its
     *   broker to ensure thread safety. 
