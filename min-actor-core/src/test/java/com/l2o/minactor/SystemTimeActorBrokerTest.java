...
public class SystemTimeActorBrokerTest {
	...
	// This may be an unexpected behaviour: Since the event is added out of thread, it will go through
	//  the async queue until the thread is running. Removing it at this time will not work.
	testee.addTimeEventFromNow("timeEvent", handler, 200);
	testee.addTimeEventFromNow(ActorBroker.Command.KILL, null, 500);
